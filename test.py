...
class SensorFailure():
    ...
    def __init__(self):
        super().__init__()        
class IllPosedGoalFailure():
    """"""
    def __init__(self):
        super().__init__()        
class CapabilityAbsenceFailure():
    """"""
    def __init__(self):
        super().__init__()        
...
class Timeout():
    ...
    def __init__(self):
        super().__init__()        
class EndEffectorFailure():
    """"""
    def __init__(self):
        super().__init__()        
class ObjectUnavailable():
    """"""
    def __init__(self):
        super().__init__()        
